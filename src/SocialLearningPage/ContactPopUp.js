        ...
        <Modal.Body
          ...
          <div style={{ padding: "7%" }}>
            ...
            <Container>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", flexDirection: "row" }}>
                <div>
                  <a style={{ textDecoration: "none", color: "white" }} href={"mailto:?" + "subject=Shared Link Of Social Learning Videos" + "&body=Social Learning Video Link From" + "https://www.thenextgig.net/" + `${props.VideoID}`}
                    target="_blank"><img style={{ cursor: "pointer", alignItems: "center" }} src="Gmail_Homepage.png" height="45px"></img>
                    <p>&nbsp; Gmail</p></a>
                </div>
                <div onClick={() => myClipboard("https://www.thenextgig.net/" + props.VideoID)}>
