...
function ProfilePage(props) {
  ...
  function whichColor(word) {
    setActive(word)
    if (word === "Personal") {
      setColor1(bg); setColor2({}); setColor3({}); setColor4({});
    }
    else if (word === "Education") {
      setColor2(bg); setColor1({}); setColor3({}); setColor4({});
    }
    else if (word === "WorkEx") {
      setColor3(bg); setColor1({}); setColor2({}); setColor4({});
    }
    else if (word === "CvPitch") {
      setColor4(bg); setColor1({}); setColor2({}); setColor3({});
    }
  }
  return (
    <Container>
      <Row>
        <Col xs={3} style={{ backgroundColor: "#1B1C2A" }} className="Profile_list_laptop">
          ...
          <hr style={{ color: "#F26C4F", margin: "2px 0px" }} />
          <Row onClick={() => whichColor("Education")} style={color2}><p style={{ fontSize: "20px", textAlign: "center", cursor: "pointer" }}>Education</p></Row>
          <hr style={{ color: "#F26C4F", margin: "2px 0px" }} />
          <Row onClick={() => whichColor("WorkEx")} style={color3}><p style={{ fontSize: "20px", textAlign: "center", cursor: "pointer" }}>Work Experience</p></Row>
          <hr style={{ color: "#F26C4F", margin: "2px 0px" }} />
          <Row onClick={() => whichColor("CvPitch")} style={color4}><p style={{ fontSize: "20px", textAlign: "center", cursor: "pointer" }}>CV / Other Documents</p></Row>
          <hr style={{ color: "#F26C4F", margin: "2px 0px" }} />
        </Col>
          ...
          <div >
            ...
            <div className="mobile_nav_profile">
              ...
              <div style={{ display: "flex", justifyContent: "space-evenly" }}>
                ...
                <div><button onClick={() => buttonColor("CvPitch")} style={{ backgroundColor: color44, color: textColor4, borderRadius: "40px", width: "100px", height: "30px", fontWeight: "bold", border: "0px" }}>CV</button></div>
              </div>
            </div>
          </div>
          <br />
