...
function ProfilePage(props) {
  ...
  function whichColor(word) {
    ...
    if (word === "Personal") {
      ...
      setColor2(bg); setColor1({}); setColor4({}); setColor3({}); setColor5({}); setColor6({});
    }
    ...
    <Container>
      <Row>
        <Col xs={3} style={{ backgroundColor: "#1B1C2A", height: "100%" }} className="Profile_list_laptop">
          ...
          <hr style={{ color: "#F26C4F", margin: "2px 0px" }} />
          <Row onClick={() => whichColor("My Videos")} style={color6}><p style={{ fontSize: "20px", textAlign: "center", cursor: "pointer" }}>My Videos</p></Row>
        </Col>
          ...
          <div >
            ...
            <div className="mobile_nav_profile">
              ...
              <div style={{ display: "flex", justifyContent: "space-evenly" }}>
                ...
                <div><button onClick={() => buttonColor("My Videos")} style={{ backgroundColor: color66, color: textColor6, borderRadius: "40px", width: "100px", height: "30px", fontWeight: "bold", border: "0px" }}>My Videos</button></div>
              </div>
            </div>
          </div>
          <br />
        ...
        <Col >
          ...
          {active === "My Videos" && <Video videospur={vpurchased} videoswatch={vwatched} />}
        </Col>
      </Row>
    </Container>
  );
