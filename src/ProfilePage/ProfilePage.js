      ...
      <Container>
        <Row>
            <Col xs={3} style={{backgroundColor:"#1B1C2A", height:"90vh"}} className="Profile_list_laptop">
              ...
              <p style={{fontSize:"14px", textAlign:"center"}}>(Complete the profile to earn TNG Learn Coins)</p>
              ...
              <br/>
              <Row><p style={{fontSize:"16px", textAlign:"center",color:"#F26C4F"}}>TNG Learn Coins: <b>{rew}</b></p></Row>
