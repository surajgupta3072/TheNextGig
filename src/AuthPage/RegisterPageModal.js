      ...
      >
        <Modal.Body style={{backgroundImage:`url("/wall.png")`,border:"1px solid rgba(255, 255, 255,0.3)",backgroundColor:"#020312"}}>
          <div>
            ...
            <p style={{fontSize:"24px",marginLeft:"3%"}}>1. Earn <text style={{color:"#f26c4f"}}>TNG Learn Coins</text> and use it to redeem TNG Originals<br/>2. Increase your chances of scoring a <text style={{color:"#f26c4f"}}> gig, project or job</text></p>
