...
//       transparent={true}
//     >
//       <Modal.Body style={{ backgroundImage: `url("https://websitestaticimages.s3.ap-south-1.amazonaws.com/wall.png")`, border: "1px solid rgba(255, 255, 255,0.3)", backgroundColor: "#020312" }}>
//         <div>
//           <p style={{ fontSize: "24px" }}>Complete your profile to: </p>
//           <p style={{ fontSize: "24px", marginLeft: "3%" }}>Congratulations! You have received 180 TNG Minutes; redeem coins to unlock TNG Originals. <br />  For earning more coins, upload videos / blogs under Social Learning</p>
