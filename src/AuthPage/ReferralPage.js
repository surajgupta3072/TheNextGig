    ...
    if(refcode!==wholedata.ReferralCode) {
      docClient.scan({TableName: "UsersTable"}, function (err, data) {
        if (err) {
          ...
          var refstatus = false;
          if(["IIMAPARTNER01", "XLRIPARTNER60", "IIMLPARTNER04", "MDIPARTNER02", "IIMKPARTNER90", "FMSPARTNER20", "IIFTPARTNER1", "IIMSPARTNER45", "IIMNPARTNER02", "MITPARTNER20", "MICAPARTNER01", "IITKGPPARTNER05", "ROTOFEST50", "NITIEPARTNER01"].includes(refcode)) {
            var refstatus = true;
            var paramss = {
