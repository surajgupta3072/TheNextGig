                ...
                <div className="appreciation">
                  <Container>
                    <div style={{ fontSize: "20px" }}>
                      <br />
                      <p className="img_text"><img alt="..." src="https://websitestaticimages.s3.ap-south-1.amazonaws.com/tick.png" />&nbsp;&nbsp;Domain: {gigs[0].GigDomain}</p>
                      <p className="img_text"><div style={{ display: "flex", justifyContent: "flex-start" }}><div><img alt="..." src="https://websitestaticimages.s3.ap-south-1.amazonaws.com/tick.png" /></div>&nbsp;&nbsp;<div>Industry: {gigs[0].CompanyIndustry}</div></div></p>
                      <p className="img_text"><div style={{ display: "flex", justifyContent: "flex-start" }}><div><img alt="..." src="https://websitestaticimages.s3.ap-south-1.amazonaws.com/tick.png" /></div>&nbsp;&nbsp;<div>Company Description: {gigs[0].CompanyDescription}</div></div></p>
                      <p className="img_text"><div style={{ display: "flex", justifyContent: "flex-start" }}><div><img alt="..." src="https://websitestaticimages.s3.ap-south-1.amazonaws.com/tick.png" /></div>&nbsp;&nbsp;<div>Duration: {gigs[0].GigDuration}</div></div></p>
                      <p className="img_text"><div style={{ display: "flex", justifyContent: "flex-start" }}><div><img alt="..." src="https://websitestaticimages.s3.ap-south-1.amazonaws.com/tick.png" /></div>&nbsp;&nbsp;<div>Stipend: {gigs[0].GigStipend}</div></div><br /></p>
                    </div>
                  </Container>
                </div>
