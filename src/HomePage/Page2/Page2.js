    ...
    <div id="ummm" style={{marginTop:"5%"}}>
      <div className="page2_laptop_view">
        ...
        Here is everything you can do on the platform: 
          ...
          <Row>
            <Card className="page2card" onClick={()=>window.location.href="/TNGoriginals"} style={{ width: "29.9%", marginLeft:"2%",backgroundColor:"rgba(242, 108, 79, 0.07)", border:"2px solid rgb(242, 108, 79,0.6)", borderRadius:"12px"}}>
