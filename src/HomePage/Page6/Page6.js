    ...
    <div className="page6_maindiv">
        <div className="image_page6">
            <div className="numbers_page6">
               ...
               <h1 className="awards_number" ><span className="number3"></span><BsSlash className="liner_page6 liner_3"/><h5 style={{fontSize:"1.1rem",color:"white",marginLeft:"-3px", textAlign: "center", marginLeft: "-55%"}}> minutes of <br /> learning <br /> content</h5></h1>
