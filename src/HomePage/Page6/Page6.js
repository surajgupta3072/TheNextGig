        ...
        <div className="page6_maindiv">
            <div className="image_page6">
                <div className="numbers_page6">
                    <h1 className="client_number"><span className="number1">7800+</span><BsSlash className="liner_page6 liner_1" /><h5 style={{ fontSize: "1.1rem", color: "white", marginLeft: "32px" }}>Minutes<br />spent</h5></h1>
                    <h1 className="projects_number"><span className="number2">120+</span><BsSlash className="liner_page6 liner_2" /><h5 style={{ fontSize: "1.1rem", color: "white", textAlign: "center", marginLeft: "-55%" }}>Videos</h5></h1>
                    <h1 className="awards_number" >550+<span className="number3"></span><BsSlash className="liner_page6 liner_3" /><h5 style={{ fontSize: "1.1rem", color: "white", textAlign: "center", marginLeft: "-55%" }}>Minutes of <br /> available <br /> content</h5></h1>
                ...
                <div className="numbers_page6_mobile">
                    <h1 className="client_number"><span>7800+</span><div className="slasher"><BsSlash className="liner_page6 liner_1" /></div><h5 style={{ fontSize: "1rem", color: "white" }}>Minutes<br />spent</h5></h1>
                    <h1 className="projects_number"><span >120+</span><div className="slasher"><BsSlash className="liner_page6 liner_2" /></div><h5 style={{ fontSize: "1rem", color: "white" }}>Videos</h5></h1>
