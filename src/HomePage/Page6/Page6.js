    ...
    <div className="page6_maindiv">
        <div className="image_page6">
            <div className="numbers_page6">
               ...
               <h1 className="experience_number"><span className="number4"></span><h5 style={{fontSize:"1.1rem",color:"white",marginTop:"4px", textAlign: "center", marginLeft: "-40%"}}>Partner <br /> Organisations</h5></h1>
            </div>
