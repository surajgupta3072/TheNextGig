    ...
    <div className="page6_maindiv">
        <div className="image_page6">
            ...
            <div className="numbers_page6_mobile">
                ...
                <h1 className="projects_number"><span className="number2"></span><div className="slasher"><BsSlash className="liner_page6 liner_2"/></div><h5 style={{fontSize:"1rem",color:"white"}}>Projects</h5></h1>
               <h1 className="awards_number" ><span className="number3"></span><div className="slasher"><BsSlash className="liner_page6 liner_3"/></div>
               <h5 style={{fontSize:"1rem",color:"white"}}>Applications</h5></h1>
               <h1 className="experience_number"><span className="number4"></span><h5 style={{fontSize:"1rem",color:"white"}}>Mastersessions</h5></h1>
            </div>
