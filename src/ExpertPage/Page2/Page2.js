        ...
        <div>
            {/* {<Carousel  breakPoints={breakPoints}>} */}
               <MDBCard className="mbd_card card_mastercard" style={{borderRadius:"0px", margin:"4%", border:"2px solid rgba(242, 108, 79, 0.6)", backgroundColor:"#020312"}}>
                    ...
                    <MDBCardBody>
                    <div className="Course_name">NAME OF EXPERT</div>
                    ...
                    <div className="img_arr" style={{marginLeft: "35px"}}>
                      <img className="img_company" src="https://www.clipartkey.com/mpngs/m/153-1539728_cartoon-person-waving-cartoon-person-png.png" />
                      <img className="img_company" src="https://www.clipartkey.com/mpngs/m/153-1539728_cartoon-person-waving-cartoon-person-png.png" />
                      <img className="img_company" src="https://www.clipartkey.com/mpngs/m/153-1539728_cartoon-person-waving-cartoon-person-png.png" />
                    </div>
