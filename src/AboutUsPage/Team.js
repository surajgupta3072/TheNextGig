                ...
                <Container style={{marginTop:"7%"}}>
                    <Row>
                        ...
                        <Card  style={{ width: "22%",minHeight:"25%", marginLeft: "3%", backgroundColor: "rgba(86, 150, 112, 0.07)", border: "2px solid rgba(86, 150, 112, 0.6)" }}>
                            <Card.Img style={{ margin: "auto", height: "140px", width: "140px", marginTop: "30px", background: "white", borderRadius: "50%", border: "0px" }} variant="top" src="https://usersdp.s3.ap-south-1.amazonaws.com/Nikhil+Agarwal.jpg" />
                            <Card.Body style={{ marginTop: "10%" }}>
                ...
                <Container style={{marginTop:"20px"}}>
                    <Col>
                        ...
                        <Card style={{ width: '100%', backgroundColor: "rgba(86, 150, 112, 0.07)", border: " 2px solid rgba(86, 150, 112, 0.6)",marginTop:"5%" }}>
                            ...
                            <div style={{display: "flex", flexDirection: "row"}}>
                                <Col style={{marginTop:"8px"}}>
                                <Card.Img style={{margin: "auto", height:"70px", width:"70px",borderRadius:"50%"}} variant="top" src="https://usersdp.s3.ap-south-1.amazonaws.com/Nikhil+Agarwal.jpg"/>
                                </Col>
                                <Col>
