...
import { ArrowRight, ArrowLeft, Linkedin, Whatsapp, Instagram, Youtube } from 'react-bootstrap-icons';
            ...
            <Row>
              ...
              <Col md={8} xs={7}>
                <div className="button_div_MC_Page2">
                  <a href="/ExperientialLearning"><button id="gigs_internship_projects_button" className="button_slide_MC_Page2 slide_right">Gigs / projects /<br />
        ...
        <Row>
          <Col md={7}>
            ...
            <div style={{ display: "flex", justifyContent: "space-evenly" }}>
              ...
              <div>
                <div className="button_div_MC_Page2">
                  <a href="/ExperientialLearning"><button id="gigs_internship_projects_button" className="button_slide_MC_Page2 slide_right">Gigs / projects / <br /> internships / jobs<ArrowRight className="button_arrow_MC_Page2" /></button></a>
                </div>
              </div>
            </div>
            <br />
