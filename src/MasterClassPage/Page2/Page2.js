         ...
         <Container>
           <Row>
             <Col style={{display:"flex",justifyContent:"space-evenly",flexDirection:"column"}} md={3} xs={1}>
               <img className="image1" style={{height:"50px",width:"50px"}} src="/google_logo.jpg"/>
               <img className="image2" style={{height:"50px",width:"50px"}} src="/google_logo.jpg"/>
               <img className="image3" style={{height:"50px",width:"50px"}} src="/google_logo.jpg"/>
               <img className="image4"style={{height:"50px",width:"50px"}} src="/google_logo.jpg"/>
             </Col>
             <Col>
            <Row className="mast_page2_row"><p className="mast_page2_p4">Meet the experts!</p></Row>
            <Row className="super_men_women" style={{marginBottom:"0%"}}><p style={{marginBottom:"0%"}} className="mast_page2_p5">Superwomen. Supermen.</p></Row>
